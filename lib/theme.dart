...
class MaterialTheme {
  ...
  static ColorScheme lightScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xff695f12),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xfff3e48a),
      onTertiaryContainer: Color(0xff504700),
      ...
      tertiaryFixed: Color(0xfff3e48a),
      onTertiaryFixed: Color(0xff201c00),
      tertiaryFixedDim: Color(0xffd6c871),
      onTertiaryFixedVariant: Color(0xff504700),
  ...
  static ColorScheme lightMediumContrastScheme() {
    return const ColorScheme(
      ...
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff796e20),
      ...
      tertiaryFixed: Color(0xff796e20),
      onTertiaryFixed: Color(0xffffffff),
      tertiaryFixedDim: Color(0xff5f5506),
  ...
  static ColorScheme lightHighContrastScheme() {
    return const ColorScheme(
      ...
      onSecondaryContainer: Color(0xffffffff),
      tertiary: Color(0xff322c00),
      onTertiary: Color(0xffffffff),
      tertiaryContainer: Color(0xff534a00),
      onTertiaryContainer: Color(0xffffffff),
      ...
      onSecondaryFixedVariant: Color(0xffffffff),
      tertiaryFixed: Color(0xff534a00),
      onTertiaryFixed: Color(0xffffffff),
  ...
  static ColorScheme darkScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xffd6c871),
      onTertiary: Color(0xff373100),
      tertiaryContainer: Color(0xff504700),
      onTertiaryContainer: Color(0xfff3e48a),
  ...
  static ColorScheme darkMediumContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xffecde84),
      onTertiary: Color(0xff2b2600),
      tertiaryContainer: Color(0xff9e9241),
  ...
  static ColorScheme darkHighContrastScheme() {
    return const ColorScheme(
      ...
      tertiary: Color(0xfffff1a1),
      onTertiary: Color(0xff000000),
      tertiaryContainer: Color(0xffd2c46d),
